...
var stylesheets = {};
stylesheets.input = [ './2021/src/scss/*.scss' ];
stylesheets.concat = [ './vendor/**/*.css' ];
stylesheets.watch = [ './vendor/**/*.css', './vendor/**/*.scss', './2021/src/scss/**/*.scss' ];
stylesheets.output = './2021/css';

var javascripts = {};
javascripts.input = [];
javascripts.input.push(`../mdp-web/jquery/jQuery-URL-Parser/purl.js`);
