...
for (var i = 1; i <= N; i++) {
  ...
  pageHTML += `<div class="page ${klass}" data-seq="${i}" data-slice="${slice_index}" data-visible="false" data-width="${width}" data-height="${defaultHeight}"><div class="page-toolbar-wrap"><div class="page-toolbar">
  <span class="image-xy"></span>
  <button data-action="rotate-counterclockwise"><svg id="bi-arrow-counterclockwise" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-counterclockwise" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z"/><path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466z"/></svg></button>
  <button><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/></svg></button>
  <span>#${i}</span>
  </div></div><div class="image"><img src="${placeholder}" data-placeholder-src="${placeholder}" /></div></div>`;
}
